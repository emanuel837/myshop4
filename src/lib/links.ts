...
const REPORT_MISSING_OFFLINE: Record<BranchName, string> = {
  ...
  'קניון התחנה המרכזית - ירושלים': 'https://airtable.com/appyGTA8v9mY4WcmQ/shrxgmRoaqjlvs5BF',
  ...
  'קניון מרום - רמת גן': 'https://airtable.com/appyGTA8v9mY4WcmQ/shrUQsPKnLS7krjjR',
