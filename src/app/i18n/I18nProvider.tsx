...
const translations: Record<AppLanguage, Record<TranslationKey, string>> = {
  he: {
    ...
    'report.checkMinuses': 'מינוסים במלאי 📋',
    ...
    'report.checkMinusesSubtitle': 'בדיקה יומית של תנועות מלאי חשובות',
  ...
  en: {
    ...
    'report.checkMinuses': 'Inventory Minuses 📋',
    ...
    'report.hotModelSubtitle': 'Report a product with high demand',
    ...
    'report.checkMinusesSubtitle': 'Daily check of important inventory movements',
  ...
  ru: {
    ...
    'report.checkMinuses': 'Минусы запасов 📋',
    ...
    'report.checkMinusesSubtitle': 'Ежедневная проверка важных движений запасов',
